...
<?php else : ?>
	<p><?php printf( __( 'You do not have a write permission to write in advanced-cache.php or %s1. To regenerate advanced-cache.php, please set the write permission.', 'wp-kusanagi' ), basename( WP_CONTENT_DIR ) ); ?></p>
<?php endif; ?>
<?php endif; ?>
