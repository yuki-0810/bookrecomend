...
function add_scripts() {
	wp_enqueue_style( 'question', get_stylesheet_directory_uri(). '/resources/css/question.css' );
	wp_enqueue_script( 'question-result', get_template_directory_uri() . '/resources/js/question_result.js', array( 'jquery' ), '20160608', true );
}
